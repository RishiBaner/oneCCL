...
template <comm_attr_id attrId>
bool comm_attr::is_valid() const noexcept {
...
\
    template CCL_API const typename OUT_Traits_Value<comm_attr_id, IN_attrId>::return_type& \
