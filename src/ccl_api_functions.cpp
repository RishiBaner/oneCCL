...
API_COMM_OP_PTR_EXPLICIT_INSTANTIATION(std::int8_t);
API_COMM_OP_PTR_EXPLICIT_INSTANTIATION(std::uint8_t);
API_COMM_OP_PTR_EXPLICIT_INSTANTIATION(std::int16_t);
API_COMM_OP_PTR_EXPLICIT_INSTANTIATION(std::uint16_t);
API_COMM_OP_PTR_EXPLICIT_INSTANTIATION(std::int32_t);
API_COMM_OP_PTR_EXPLICIT_INSTANTIATION(std::uint32_t);
API_COMM_OP_PTR_EXPLICIT_INSTANTIATION(std::int64_t);
API_COMM_OP_PTR_EXPLICIT_INSTANTIATION(std::uint64_t);
...
API_COMM_OP_REF_EXPLICIT_INSTANTIATION(sycl::buffer<std::int8_t COMMA 1>);
API_COMM_OP_REF_EXPLICIT_INSTANTIATION(sycl::buffer<std::uint8_t COMMA 1>);
API_COMM_OP_REF_EXPLICIT_INSTANTIATION(sycl::buffer<std::int16_t COMMA 1>);
API_COMM_OP_REF_EXPLICIT_INSTANTIATION(sycl::buffer<std::uint16_t COMMA 1>);
API_COMM_OP_REF_EXPLICIT_INSTANTIATION(sycl::buffer<std::int32_t COMMA 1>);
API_COMM_OP_REF_EXPLICIT_INSTANTIATION(sycl::buffer<std::uint32_t COMMA 1>);
API_COMM_OP_REF_EXPLICIT_INSTANTIATION(sycl::buffer<std::int64_t COMMA 1>);
API_COMM_OP_REF_EXPLICIT_INSTANTIATION(sycl::buffer<std::uint64_t COMMA 1>);
